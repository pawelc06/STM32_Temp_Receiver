...
#define RFM69_SPI_CS_PIN GPIO_PIN_8
#define RFM69_SPI_CS_PORT GPIOA

#define RFM69_RESET_PIN GPIO_PIN_11
#define RFM69_RESET_PORT GPIOA

#define RFM69_SPI_PORT hspi2
extern SPI_HandleTypeDef RFM69_SPI_PORT;
